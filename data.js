...
const COSTS = {
  ...
  c30: { label: "Villa Canggu (13-19/09, 6n, gedeeld door 8)", cat: "accommodatie", amount: 226.87, url: "https://www.airbnb.com/l/ZBZK43sb", location: "Kecamatan Kuta Selatan, Bali", host: "Rachel" },
...
const TRIP = [
  ...
  { id:"t10b", fase:"java", start:"2026-09-11", end:"2026-09-12", title:"🌋 Tumpak Sewu & Bromo (alle 9)", details:["11/09: Tumpak Sewu waterval (±2,5u rijden vanuit Malang).", "12/09: om 3u 's nachts op voor Mount Bromo bij zonsopgang.", "Daarna taxi naar Banyuwangi.", "Matthew doet dit programma volledig mee met de jongens — Bromo en Tumpak Sewu ziet hij op 16/09 een tweede keer, dan samen met Hinke."], costs:["c37"], map:["malang","tumpak_sewu","bromo","banyuwangi"] },
  { id:"t11", fase:"bali", start:"2026-09-13", end:"2026-09-15", title:"🏄 Canggu — twee dagen Bali met de jongens (Matthew)", details:["Matthew blijft na de ferry twee dagen in Canggu bij de jongens: strand, surf en bijkomen na de vulkanen.", "Op 15/09 in de namiddag naar Ngurah Rai (DPS) voor de vlucht naar Surabaya.", "Let op: verblijf nog te regelen — de villa in Canggu is voor 8 personen geboekt, Matthew is de negende."], costs:["c36"], map:["canggu"], openNote: true },
  ...
  { id:"t30", fase:"java", start:"2026-09-13", end:"2026-09-13", title:"🔥 Kawah Ijen 's nachts (alle 9)", details:["Om 1u 's nachts op voor de Kawah Ijen-hike: blauwvuur en zwavelmeer bij zonsopgang.", "Matthew gaat mee; op 17/09 doet hij de hike nog een keer, dan met Hinke."], costs:["c38"], map:["banyuwangi","ijen"], duration: "~4-5u hike" },
